...
$styles ??= [];
$scripts ??= [];
array_unshift($styles, 'lobby');
array_unshift($scripts, 'lobby');
$without_main = true;
...
<header class="header">
    ...
    <section id="menus" class="header__menus">
        ...
        <!-- Configuration -->
        <a class="header__menu-anchor" href="/settings">
            <svg class="icon icon--sm" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
...
<main class="main">
    <?php if (isset($_SESSION['auth'])): ?>
        <a href="/profile/<?= $_SESSION['auth']['profile']['id'] ?>" class="profile">
            <!-- Image -->
            <div class="profile__column">
                <figure class="profile__figure">
                    <img class="profile__image" src="img/profile/<?= $_SESSION['auth']['profile']['avatar'] ?>.webp" alt="Profile picture">
                </figure>
            </div>
            ...
            <div class="profile__column">
                ...
                <div class="profile__points">
                    ...
                    <svg class="icon icon--xs icon--min-xs spining" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
