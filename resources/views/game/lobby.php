<?php
$title = 'Play lobby';
$styles = ['play', 'mini_profile', 'modal'];
$scripts = ['play', 'modal'];
require_once BASE . 'resources/components/header_menus.php';
?>

<h1 class="invisible">Game lobby</h1>
    ...
    <div id="play-modes" class="play">
        ...
        <div class="play__modes">
            <h2 class="play__title">
                ...
                <span data-translate="Local modes">Local modes</span>
            </h2>
    ...
    <div class="modal__content modal__content--separate">
        ...
        <div class="modal__options">
            <a class="modal__tooltip" href="/play/offline/robot?difficulty=easy">
                ...
                <span class="modal__tooltip-text modal__tooltip-text--static" data-translate="Easy">Easy</span>
            </a>
            <a class="modal__tooltip" href="/play/offline/robot?difficulty=normal">
                ...
                <span class="modal__tooltip-text modal__tooltip-text--static" data-translate="Normal">Normal</span>
            </a>
            <a class="modal__tooltip" href="/play/offline/robot?difficulty=hard">
                ...
                <span class="modal__tooltip-text modal__tooltip-text--static" data-translate="Hard">Hard</span>
            </a>
        </div>
    </div>
</dialog>
