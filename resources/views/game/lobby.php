...
<dialog id="modal-robot" class="modal">
    <div class="modal__content">
        ...
        <div class="modal__options">
            <a class="modal__button" href="/play/offline/robot?difficulty=easy">
                <svg class="icon icon--sm icon--min-xs" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a class="modal__button" href="/play/offline/robot?difficulty=normal">
                <svg class="icon icon--sm icon--min-xs" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a class="modal__button" href="/play/offline/robot?difficulty=hard">
                <svg class="icon icon--sm icon--min-xs" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
