    ...
    <form id="form-signin" class="form form--hidden form--red" action="/signin" method="post">
        <div class="form__content">
            ...
            <div class="form__options">
                ...
                <a href="/access?section=signup&animation=true" class="anchor text-center" data-action="change-section" data-translate="Don't have an account yet?">Don't have an account yet?</a>
            </div>
        </div>
    </form>
